        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<FAQ>().HasData(
                ...
                new FAQ
                {
                    ...
                    Answer = "Entity Framework (EF) is an open-source Object-Relational Mapper (ORM) framework for ADO.NET, developed by Microsoft.",
                    TopicId = "ef",
                    CategoryId = "gen"
                },
                new FAQ
                {
                    ...
                    Answer = "Entity Framework was released in 2008.",
                    TopicId = "ef",
                    CategoryId = "hist"
                }
                );
